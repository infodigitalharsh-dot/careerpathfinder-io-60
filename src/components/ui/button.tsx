  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-primary text-primary bg-background hover:bg-primary hover:text-primary-foreground shadow-soft hover:shadow-medium",
        ...
        hero: "bg-gradient-primary text-primary-foreground hover:bg-gradient-to-r hover:from-primary-light hover:to-saffron shadow-medium hover:shadow-strong transform hover:scale-105",
        saffron: "bg-saffron text-saffron-foreground hover:bg-saffron-light shadow-soft hover:shadow-medium transform hover:scale-105",
